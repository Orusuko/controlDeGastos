...
export function IconSettings(props: Props) {
  return (
    <Svg {...props}>
      ...
      <path d="M19.13 12.92v-1.84l1.72-1.22-.96-1.9-2.06.46a6.9 6.9 0 0 0-1.59-.92l-.34-2.08h-2.18l-.34 2.08a6.9 6.9 0 0 0-1.59.92l-2.06-.46-.96 1.9 1.72 1.22v1.84l-1.72 1.22.96 1.9 2.06-.46c.5.38 1.03.69 1.59.92l.34 2.08h2.18l.34-2.08c.56-.23 1.09-.54 1.59-.92l2.06.46.96-1.9-1.72-1.22z" />
    </Svg>
  );
}
